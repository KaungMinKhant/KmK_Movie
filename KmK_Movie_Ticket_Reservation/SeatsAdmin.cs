...
{
    public partial class SeatsAdmin : Form
    {
        ...
        public bool Insert_Seat(string a)
        {
            string query = $"INSERT INTO seats(id, name) values('','{a}');";
            try
            {
                if (OpenConnection())
                {
        ...
        public void Delete_Seat()
        {
            ...
            string query = $"DELETE FROM seats WHERE id = {itemToDelete};";
            try
            {
                if (OpenConnection())
                {
