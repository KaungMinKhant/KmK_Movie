...
{
    public partial class AuditoriumsAdmin : Form
    {
        ...
        public bool Insert_Auditorium(string a)
        {
            string query = $"INSERT INTO auditoriums(id, name) values('','{a}');";
            try
            {
                if (OpenConnection())
                {
        ...
        public void Delete_Auditorium()
        {
            ...
            string query = $"DELETE FROM auditoriums WHERE id = {itemToDelete};";
            try
            {
                if (OpenConnection())
                {
        ...
        {
            name = textBox1.Text;
            if (Insert_Auditorium(name))
            {
                MessageBox.Show($"{name} is inserted.");
                Show_Table();
                textBox1.Clear();
            }
        }
